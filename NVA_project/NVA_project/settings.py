"""
Django settings for NVA_project project.
...
SECRET_KEY = 'django-insecure-9&7e@gh+l=-o09cztatxg!(s!dohvkio_0sz!twu7zi7kz_n_$'
...
WSGI_APPLICATION = 'NVA_project.wsgi.application'
...
LOGGING = {
    ...
    'root': {
        'handlers': ['console'],
        'level': 'INFO',  # <= IMPORTANT pour voir les logger.info()
    },
    'loggers': {
        'django': {
            'handlers': ['console'],
